...
const Paging = ({ page, numberOfPages, hasNextPage, hasPreviousPage, pageRangeDisplayed, pageMarginDisplayed, onPageChange }) => {
    ...
    return (
        <div className="Pagination">
            <span
                className={classnames("Pagination-previous", hasPreviousPage ? "Pagination-active" : "")}
            ...
            {displayedPages.map((pageNum, index) => (
                <React.Fragment key={pageNum}>
                    {pageNum > displayedPages[index - 1] + 1 ? (
                        <span
                            className={classnames("Pagination-ellipsis")}
                    ...
                    <span
                        className={classnames("Pagination-page", page === pageNum ? "Pagination-active" : "")}
            ...
            <span
                className={classnames("Pagination-previous", hasNextPage ? "Pagination-active" : "")}
                onClick={() => onPageChange(page + 1)}
            >
                {'>'}
            </span>
